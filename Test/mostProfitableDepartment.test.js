...
describe('mostProfitableDepartment' , function(){
    it('should return most profitable department, outdoor' , function(){
        assert.deepEqual(mostProfitableDepartment(data), 'outdoor');
    });


    it('should return most profitable department, electronics' , function(){
        assert.deepEqual(mostProfitableDepartment(data2), 'electronics');
    });
